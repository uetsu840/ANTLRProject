...
TOKEN_BIN_NUMBER    : BIN_PREFIX BIN_NUMBER (USCORE BIN_NUMBER)*;
TOKEN_FP_NUMBER     : DEC_NUMBER DOT DEC_NUMBER;
TOKEN_CASE_RANGE    : DOT DOT;
TOKEN_PLUS          : PLUS;
TOKEN_MINUS         : MINUS;
TOKEN_MUL           : ASTERISK;
TOKEN_DIV           : SLASH;
TOKEN_ARG_LBL_SEP   : COMMA;
TOKEN_CASE_LBL_SEP  : COLLON;
TOKEN_AND           : AND | 'AND';
TOKEN_XOR           : 'XOR';
TOKEN_OR            : 'OR';
TOKEN_TYPE_LREAL    : 'LREAL';
TOKEN_TYPE_REAL     : 'REAL';
TOKEN_TYPE_INT      : 'INT';
TOKEN_TYPE_UINT     : 'UINT';
TOKEN_TYPE_DINT     : 'DINT';
TOKEN_TYPE_UDINT    : 'UDINT';
...
fragment BIN_NUMBER     : BIN_DIGIT BIN_DIGIT BIN_DIGIT BIN_DIGIT;
